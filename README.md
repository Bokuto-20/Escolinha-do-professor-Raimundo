...
Framework Web
Django
Framework de alto nível para desenvolvimento rápido e seguro.
Banco de Dados
db.sqlite3 (Padrão)
Banco de dados inicial, facilmente configurável para PostgreSQL ou MySQL.
PLN
spaCy e dependências relacionadas
Utilizado para o processamento e análise automática de textos.
Frontend
HTML/CSS/JavaScript
Estrutura e interatividade da interface do usuário (provavelmente utilizando templates do Django).
